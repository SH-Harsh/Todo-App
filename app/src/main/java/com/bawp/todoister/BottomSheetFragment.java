...
public class BottomSheetFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    private ImageButton calendraButton;
    ...
    public View onCreateView(
        ...
        calendraGroup = view.findViewById(R.id.calendar_group);
        calendarView = view.findViewById(R.id.calendar_view);
        calendraButton = view.findViewById(R.id.today_calendar_button);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        calendraButton.setOnClickListener(v -> {
            calendraGroup.setVisibility(
                    calendraGroup.getVisibility() == View.GONE ? View.VISIBLE : View.GONE);
